    ...
    >
      ...
      >
        ...
        <Text style={styles.sub}>
          Since you selected 'Other', please describe your specific job needs so
        ...
        <StyledInput
          placeholder={
            "E.g., I'm looking for a 4-day work week, specifically in the sustainable energy sector with a focus on Vue.js..."
          }
        ...
        <View style={styles.toggleCard}>
          ...
          <View style={styles.toggleText}>
            ...
            <Text style={styles.toggleSub}>
              Flag this request as urgent to get matching roles sent to your
              inbox immediately.
            </Text>
          </View>
          <Switch
