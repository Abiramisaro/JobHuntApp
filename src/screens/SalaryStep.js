    ...
    >
      ...
      >
        ...
        <Text style={styles.sub}>
          Be transparent about your expectations to find the best match.
        </Text>
        ...
        <View style={styles.salaryRow}>
          <View style={styles.salaryField}>
            ...
            <View style={styles.salaryInput}>
              ...
              <StyledInput
              inlineStyle={{width: "140"}}
                placeholder="70,000"
                value={answers.salaryMin}
                onChangeText={(v) => setAnswer("salaryMin", v)}
          ...
          <View style={styles.salaryField}>
            ...
            <View style={styles.salaryInput}>
              ...
              inlineStyle={{width: "140"}}
                ...
                onChangeText={(v) => setAnswer("salaryMax", v)}
                keyboardType="numeric"
              />
            </View>
          </View>
        ...
        <Text style={styles.salaryTip}>
          Tip: Most candidates in this role expect between $85k - $110k.
        </Text>
